...
班级:  <select class="mdui-select" mdui-select="{position: 'bottom'}" id="class" name="class">
    ...
    foreach ($class as $row){
        $classes=$row['class'];
        echo "<option value=\"$classes\">$classes 班</option>";
    }
    ?>
...
<div class="mdui-dialog mdui-color-theme" id="re" >
    <div class="mdui-container mdui-color-white mdui-dialog-content">
        <div class="mdui-textfield mdui-textfield-floating-label">
            ...
            <input class="mdui-textfield-input" type="text" value="<?php echo $infoes['name']; ?>" required name="username" id="username" />
        </div>
        <div class="mdui-textfield mdui-textfield-floating-label">
            <i class="mdui-icon material-icons">confirmation_number</i>
            <label class="mdui-textfield-label">学号</label>
            <input class="mdui-textfield-input" type="text" value="<?php echo $infoes['study_hao'];?>" required name="study_hao" id="study_hao"/>
        </div>
        <div class="mdui-textfield mdui-textfield-floating-label">
        ...
        <div class="mdui-textfield mdui-textfield-floating-label">
            ...
            <input class="mdui-textfield-input" type="text" value="<?php echo $infoes['class'];  ?>" required name="class" id="class"/>
        </div><button class="mdui-btn mdui-color-theme-accent mdui-ripple" id="submit" onclick="que()">确定</button>  <button class="mdui-btn mdui-color-theme-accent mdui-ripple" onclick="inst.close()">取消</button>
