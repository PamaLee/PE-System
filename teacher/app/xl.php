...
<form action="app/xl.php" method="post">
...
foreach ($student as $row){
    $uid=$row['uid'];
    $choose=$row['choose_what'];
    if (empty($choose)) {
        $choose_name = "该同学尚未选择选项";
    }else{
...
<div class=\"mdui-row-xs-5\">
    ...
    <div class=\"mdui-col\">
        <div class=\"mdui-textfield\">
            <input class=\"mdui-textfield-input\" type=\"text\" value='".$test_res['choose_res']."' placeholder=\"选项\" name='$uid-choose'/>
        </div>
    </div>
    <div class=\"mdui-col\">
...
?>
    <input class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple" type="submit" name="submit">
</form>
