...
<div class="mdui-row">
    <div class="mdui-col-md-6 mdui-col-offset-md-3 mdui-text-center" style="padding-bottom: 20px">
        <div class="mdui-card">
            <h2><?php echo colors(get_school_name_by_school_num($_SESSION['info']['school'])) ?></h2>
            <h3><?php echo $_SESSION['info']['grade']."年级".$_SESSION['info']['class']."班" ?></h3>
        </div>
    ...
    <div class="mdui-col-xs-6">
        <div class="mdui-card mdui-text-center">
            ...
            <h3>学生数:<?php echo link_admin()->query("select * from student where school='$school' and grade='$grade' and class='$class'")->num_rows ?>人</h3>
            <h3>总测试次数:<?php echo get_test_num($_SESSION['info']['school'], $_SESSION['info']['grade']) ?>次</h3>
            <h3>学生总登录次数:<?php echo get_student_class_login_time($_SESSION['info']['school'], $_SESSION['info']['grade'],$class) ?>
                次</h3>
        </div>
    </div>
    <div class="mdui-col-xs-6">
